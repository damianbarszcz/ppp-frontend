...
const Input: React.FC<InputProps> = ({placeholder, type, name, uiType, labelCaption, validateError, required,onChange, ...rest })  => {
    ...
    return (
        <div className="mb-10 flex flex-col relative">
            ...
            {name === "password" && (
                <span
                    className="absolute bottom-[10px] right-[15px] cursor-pointer"
                    onClick={togglePasswordVisibility}
                >
                    {isPasswordVisible ? (
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={`${uiType == 'light' ? `#161616` : `#ffffff`}`}>
