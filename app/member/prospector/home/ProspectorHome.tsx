            ...
            <main>
                <section className="w-full">
                    <div className="max-w-6xl m-auto mt-10 text-center">
                        <figure className="relative m-auto h-24 w-24 rounded-full" style={{ backgroundColor: user.profile.user_avatar_color }}>
                        ...
                        <div className="mt-5 m-auto max-w-xl">
                            <h1 className="font-body text-2xl font-regular global--text-dark">Witaj, <span className="font-semibold">{user.profile.name} {user.profile.surname}</span></h1>
                    ...
                    <div className="mt-10 m-auto grid grid-cols-2 gap-4 w-full max-w-[800px]">
                        <div className="flex flex-col justify-between min-h-54 global--border-d-white rounded-md">
                            ...
                            <div>
                                ...
                                <div className="w-full">
                                    <Link href="/member/prospector/profile" className="block pl-6 pr-6 pt-3 pb-3
                        ...
                        <div className="flex flex-col justify-between min-h-54 global--border-d-white rounded-md">
                            ...
                            <div>
                                ...
                                <div className="w-full">
                                    <Link href="/member/prospector/search-creator" className="block pl-6 pr-6 pt-3 pb-3 text-base
                        ...
                        <div className="flex flex-col justify-between  min-h-54 global--border-d-white rounded-md col-span-2">
                            ...
                            <div>
                                ...
                                <div className="w-full">
                                    <Link href="/member/prospector/teams" className="block pl-6 pr-6 pt-3 pb-3 text-base font-semibold font-body global--text-link"
                                          target="_self">
