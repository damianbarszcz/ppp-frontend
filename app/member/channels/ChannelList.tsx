                ...
                <div className="grid grid-cols-3 mt-10 mb-20 w-full gap-6">
                    ...
                    <div key={team.id} className="flex flex-col justify-between global--border-d-white rounded-md p-4">
                        <div className="flex content-center items-center">
                            <figure className="relative w-16 h-16 bg-amber-200 rounded-lg">
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-10 flex justify-end">
                                ...
                                <Link href="/member/channels/channel" className="block pt-2 pb-2 pl-6 pr-6 global--border-blue rounded-3xl
                                    text-sm font-body font-semibold global--text-link" target="_self"> Dołącz </Link>
                            </div>
                        </div>
                    </div>
                    ))}
